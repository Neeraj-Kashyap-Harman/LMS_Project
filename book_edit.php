...
function validateform() 
{
	...
	conf=confirm("The data you have changed may not be saved!\nAre you sure you want to go back to list?");
	if(conf)
	{
...
echo "<tr><td><br>         </td></tr> ";
	...
	echo "</td><td>";
	echo "  :\t\t<input type='text' size=80 name='title' value='".$row['Book_Title']."'>" ;
	echo "</td></tr>";
...
echo "</td><td>";
echo ":\t\t<input type='text' size=80 name='isbn' value='".$row['ISBN']."'>";
echo "</td></tr>";
...
echo "</td><td>";
echo ":\t\t<input type='text' size=80 name='author' value='".$row['Author']."'>";
echo "</td></tr>";
...
echo "</td><td>";
echo ":\t\t<input type='text' size=80 name='category' value='".$row['Category']."'>" ;
echo "</td></tr>";
...
echo "</td><td>";
echo ":\t\t<input type='text' size=80 name='copy1' value='".$row['No_of_copies']."'>";
echo "</td></tr>";
...
echo "</td><td>";
echo ":\t\t<input type='text' size=80 name='copy2' value='".$row['Available_copies']."'>";
echo "</td></tr>";
...
echo "</td><td>";
echo ":\t\t<input type='text' size=80 name='page' value='".$row['No_of_pages']."'>";
echo "</td></tr>";
...
if(isset($_POST['save']))
{
	...
	$sql = "update Book set Book_Title='$title',ISBN='$isbn',Category='$cat',Author='$author',No_of_copies=$no_copy,Available_Copies=$a_copy,No_of_pages=$pages where Book_id=$bookid";
