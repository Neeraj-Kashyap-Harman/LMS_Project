...
//$query="SELECT count(issue_id) ,monthname(return_date) from Issue GROUP BY monthname(return_date) ORDER BY return_date";
$query="select count(*) ,monthname(start_date) from transaction where type='reserve'";
