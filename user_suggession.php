...
?>
	...
	<input type='submit' name='submit_btn' value='Submit' style="color:white; width:70px; height:35px; background-color:#F39C12; "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	<input type='submit' name='cancel_btn' value='Cancel' style="color:black; width:70px; height:35px; background-color: #D0D0D0;">
...
<?php
	...
	if(isset($_POST['submit_btn']))
	{
		...
		$date = date('Y-m-d');
		//echo $txt;
		$sql="insert into suggessions(notes,date,u_id) values('".$text."','".$date."',".$uid.")";
	
		mysqli_query($conn,$sql);
		echo "<script type='text/javascript'>";
		echo "alert('Suggessions Successfully Saved.'); ";
		echo "window.location.href='user_suggession.php?uid=$uid';";
                echo "</script>";
 	 	}
	...
	{
		echo "<script type='text/javascript'>";
		echo "window.location.href='userindex.php?uid=$uid';";
                echo "</script>";
	}
