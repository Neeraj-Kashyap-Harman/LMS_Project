...
<a href="user_issue_notify.php" id="notificationLink" onclick = "return getNotification()"></a>
...
<a href="user_reserve_notify.php" id="notificationLink" onclick = "return getNotification()"></a>
<div id="HTMLnoti" style="textalign:center"></div>
<div> Reserved Books</div>
                                    </div>
                                </div>
                            </div>
                            <a href="user_reserve_notify.php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
...
$imgurl='http://covers.openlibrary.org/b/isbn/'.$row1['ISBN'].'-M.jpg';
	echo "<a href=rec_refer.php?category=".$row1['Book_id']."><img src=".$imgurl." width='170' height='200' /></a>"; 
